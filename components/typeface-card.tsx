...
export function TypefaceCard({ typeface }: { typeface: DirectoryEntry }) {
  ...
  return (
    <div className="relative group border-[0.5px] border-border overflow-hidden">
      <Link
        href={detailUrl}
      ...
      <div className="absolute inset-x-0 bottom-0 translate-y-full group-hover:translate-y-0 transition-transform duration-200 flex border-t-[0.5px] border-border bg-background">
        <Link
          href={detailUrl}
